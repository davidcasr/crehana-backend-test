...
def create_task_list(request: TaskListCreateRequest, db: Session = Depends(get_db)):
...
def get_task_list(task_list_id: int, db: Session = Depends(get_db)):
...
def update_task_list(
    task_list_id: int, request: TaskListUpdateRequest, db: Session = Depends(get_db)
):
    """Update a task list."""
    try:
        use_cases = get_task_list_use_cases(db)
